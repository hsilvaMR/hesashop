            ...
            <div class="col-4 menu-esquerda mt-3">
                <div class="d-flex flex-column mb-3">
                    <div class="p-2 catTitulo">
                        Categoria
                        <img src="{{ asset('loja/img/setaBaixo.svg') }}" id="hideMenu" class="mt-2" height="19"
                            width="19" loading="lazy">
                            <i class="fa-solid fa-chevron-up d-none" id="showMenu"></i>
                    </div>
            ...
            <div class="col-8 menu-direita">
                ...
                <div class="d-flex flex-row align-items-center">
                    <div class="p-2 text-center">
                        <img src="{{ asset('loja/img/home.svg') }}" id="imgHome" height="15" width="15"
                            loading="lazy">
                    ...
                    <div class="p-2 carrinho mx-auto ">
                        <img src="{{ asset('loja/img/carinho.svg') }}" class="me-2" height="15" width="15"
                            loading="lazy">
